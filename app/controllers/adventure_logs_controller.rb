class AdventureLogsController < ApplicationController
  ...
  def create
    ...
    redirect_to user_character_adventure_logs_path(@character.user, @character)
  end
  ...
  def update
    ...
    respond_to do |format|
      if @adventure_log.update(adventure_log_params)
        format.html { redirect_to user_character_adventure_logs_path(@character.user, @character), notice:  "Entry was successfully updated." }
