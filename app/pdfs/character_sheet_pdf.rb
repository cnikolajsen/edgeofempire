...
#  start_new_page
  ...
  bounding_box([bounds.left, (bounds.top - 5)], :width => bounds.width, :height => 240) do
    ...
    bounding_box([bounds.left, (bounds.top - 17)], :width => (bounds.width / 2), :height => 60) do
      #fill_color "C0C0C0"
      #rounded_rectangle [bounds.left, bounds.top], bounds.width, bounds.height, 5
      #fill_and_stroke
    ...
    bounding_box([(bounds.left + (bounds.width / 2)), (bounds.top - 17)], :width => (bounds.width / 2), :height => 60) do
      bounding_box([bounds.left, bounds.top], :width => ((bounds.width / 4) * 3), :height => bounds.height) do
        ...
        #draw_text "#{pdf_vars['armor'].armor.name unless pdf_vars['armor'].nil?}", :size => 7, :style => :bold, :at => [(bounds.left + 60), (bounds.top - 50)]
      end
  ...
  #===== WEAPONS =====
  bounding_box([bounds.left, (bounds.top - 200)], :width => bounds.width, :height => 240) do
    fill_color "C0C0C0"
    #rounded_rectangle [bounds.left, (bounds.top - 7)], bounds.width, bounds.height, 5
    #fill_and_stroke
  ...
  #===== CYBERNETICS =====
  bounding_box([bounds.left, (bounds.top - 300)], :width => bounds.width, :height => 240) do
    fill_color "C0C0C0"
    #rounded_rectangle [bounds.left, (bounds.top - 7)], bounds.width, bounds.height, 5
    #fill_and_stroke
