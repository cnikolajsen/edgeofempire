ActiveAdmin.register_page "Developer Tools" do
  ...
  page_action :reset_character_skills, :method => :post do
    ...
    redirect_to admin_developer_tools_path, :notice => "Character skills for all characters have been reset."
  end

  page_action :reset_character_talents, :method => :post do
    ...
    redirect_to admin_developer_tools_path, :notice => "Character talents for all characters have been reset."
  end
  ...
  sidebar :help do
    ul do
      li "Developer Tools" do
        ul do
          li link_to "Reset character skills", admin_developer_tools_reset_character_skills_path, :method => :post
          li link_to "Reset character talents", admin_developer_tools_reset_character_talents_path, :method => :post
          li link_to "Reset character equipment", admin_developer_tools_reset_character_items_path, :method => :post
          li link_to "Delete all characters", admin_developer_tools_delete_characters_path, :method => :post
        end
      end
