...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { campaign_id: @adventure.campaign_id, description: @adventure.description, name: @adventure.name }
    end
  ...
  test "should update adventure" do
    put :update, id: @adventure, adventure: { campaign_id: @adventure.campaign_id, description: @adventure.description, name: @adventure.name }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
